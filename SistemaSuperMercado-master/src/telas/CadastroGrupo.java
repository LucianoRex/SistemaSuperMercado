 ...
 * @author LucianoRex
 */
public class CadastroGrupo extends javax.swing.JFrame {
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        Connection con = ConexaoMySQL.getConnection();
        String grupo = jTSubGrupo.getText();
        String sql = "INSERT INTO GRUPO(GRUPO)"
        + " VALUES(?)";
        try {
            PreparedStatement ps = con.prepareStatement(sql);
        ...
        String linha[] = {getId.getId("GRUPO", "CGRUPO"), grupo};//RETORNA O ID
        jTCodigo.setText(getId.getId("GRUPO", "CGRUPO"));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            ...
            if (linhaSelecionada >= 0) {
                ...
                + " WHERE GRUPO.CGRUPO = " + jTBGrupo.getValueAt(linhaSelecionada, 0);
                try {
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        String sql = "UPDATE GRUPO SET GRUPO = ? WHERE GRUPO.CGRUPO = ? ";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroGrupo().setVisible(true);
            }
        });
    }
