 ...
 * @author LucianoRex
 */
public class ChamaSearch extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(10, 10, 10)
                .addComponent(jTMarca, javax.swing.GroupLayout.PREFERRED_SIZE, 255, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jScrollPane2.setViewportView(jTBMarca);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
         ...
         model = (DefaultTableModel) jTBMarca.getModel();
        model.setNumRows(0);
    ...
    private void jTBMarcaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTBMarcaMouseClicked
        ...
        int linha = jTBMarca.getSelectedRow();
        jTCodigo.setText(jTBMarca.getValueAt(linha, 0).toString());
        jTMarca.setText((String) jTBMarca.getValueAt(linha, 1));
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        String linha[] = {getId.getId("MARCA", "CMARCA"), marca};//RETORNA O ID
        jTCodigo.setText(getId.getId("MARCA", "CMARCA"));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            int linhaSelecionada = jTBMarca.getSelectedRow();
            System.out.println(linhaSelecionada);
            if (linhaSelecionada >= 0) {
                Connection con = ConexaoMySQL.getConnection();
                String sql = "DELETE FROM MARCA"
                        + " WHERE MARCA.CMARCA = " + jTBMarca.getValueAt(linhaSelecionada, 0);
                try {
                    PreparedStatement st = con.prepareStatement(sql);
                    st.execute();
                    st.close();
                    model.removeRow(jTBMarca.getSelectedRow());
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        Connection con = ConexaoMySQL.getConnection();
        String marca = jTMarca.getText();
        String sql = "UPDATE MARCA SET MARCA = ? WHERE MARCA.CMARCA = ? ";
        ...
        if (btnEdit.isSelected()) {
            ...
            if (!editCancel) {
                ...
                try {
                    PreparedStatement ps = con.prepareStatement(sql);
                    ps.setString(1, marca);
                    System.out.println(jTBMarca.getValueAt(linhaSelecionada, 0));
                    ps.setInt(2, Integer.parseInt((String) jTBMarca.getValueAt(linhaSelecionada, 0)));
                    ps.execute();
                    ps.close();
                    JOptionPane.showMessageDialog(this, "Registro alterado");
                    confereBtn();
                    lista.clear();
                    lista.add(((String) jTBMarca.getValueAt(linhaSelecionada, 0)));
//                    lista.add(marca);
                    edit = false;
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
       ...
       // campos.add("unidade");
       // campos.add("cunidade");
        TabelaSearch tblsearch = new TabelaSearch(this);
        tblsearch.sql = "Select * from unidade ";
        tblsearch.jCTipo.setModel(new javax.swing.DefaultComboBoxModel(new String[]{"Código", "UF"}));
        tblsearch.campo.add("UNIDADE.CUNIDADE");
        tblsearch.campo.add("UNIDADE.UNIDADE");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ChamaSearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ChamaSearch().setVisible(true);
            }
        });
    }
    ...
    public static javax.swing.JTable jTBMarca;
