 ...
 * @author LucianoRex
 */
public class CadastroMsegment extends javax.swing.JFrame {

    /**
     * Creates new form Cadastros
     */
    public CadastroMsegment() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro de Market Segment");
    ...
    private void jTBGrupoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTBGrupoMouseClicked
        ...
        jTSubGrupo.setText((String) jTBGrupo.getValueAt(linha, 1));
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        Connection con = ConexaoMySQL.getConnection();
        String msegment = jTSubGrupo.getText();
        String sql = "INSERT INTO MSEGMENT(MSEGMENT)"
        + " VALUES(?)";
        try {
            PreparedStatement ps = con.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroMsegment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroMsegment().setVisible(true);
            }
        });
    }
