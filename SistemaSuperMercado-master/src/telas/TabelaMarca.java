 ...
 * @author LucianoRex
 */
public class TabelaMarca extends javax.swing.JFrame {
    ...
    public TabelaMarca(CadastroMarca cadMarca) {
        initComponents();
        cadastroMarca = cadMarca;        
    }
...
//        String uf = null;
        ...
        try {
            ...
            while (rs.next()) {
                String linha[] = {rs.getString("CMARCA"), rs.getString("MARCA")};
                model.addRow(linha);
                
           
                    cadastroMarca.jTMarca.setText(rs.getString("MARCA"));
                    cadastroMarca.model.addRow(linha);
...
//        cadastro.postData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TabelaMarca.class
