 ...
 * @author LucianoRex
 */
public class CadastroUf extends javax.swing.JFrame {
    ...
    public void atualizaTabela(int linhaSelecionada, ArrayList lista) {
        for (int i = 0; i < lista.size(); i++) {
            jTBUf.setValueAt(lista.get(i), linhaSelecionada, i);
        }
    }

    public void montaTabela(String id) {
        jTBUf.setVisible(true);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadasro de Estados");
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jTUf, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel3Layout.createSequentialGroup()
        ...
        jPanel2.add(jPanel3);
        jPanel3.setBounds(10, 50, 380, 100);
        ...
        jScrollPane2.setViewportView(jTBUf);
    ...
    private void jTBUfMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTBUfMouseClicked
        ...
        jTCodigo.setText(jTBUf.getValueAt(linha, 0).toString());
        jTUf.setText((String) jTBUf.getValueAt(linha, 0));
        jTNome.setText((String) jTBUf.getValueAt(linha, 1));
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        String sql = "INSERT INTO UF(UF,NOME)"
                + " VALUES(?,?)";
        try {
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setString(1, uf);
        ...
        String linha[] = {getId.getId("UF", "CUF"), uf};//RETORNA O ID
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (option == JOptionPane.YES_OPTION) {
            int linhaSelecionada = jTBUf.getSelectedRow();
            System.out.println(linhaSelecionada);
            if (linhaSelecionada >= 0) {
                Connection con = ConexaoMySQL.getConnection();
                String sql = "DELETE FROM UF"
                        + " WHERE UF.CUF = " + jTBUf.getValueAt(linhaSelecionada, 0);
                try {
                    PreparedStatement st = con.prepareStatement(sql);
                    st.execute();
                    st.close();
                    model.removeRow(jTBUf.getSelectedRow());
        ...
        if (btnEdit.isSelected()) {
            ...
            if (!editCancel) {
                ...
                try {
                    ...
                    System.out.println(jTBUf.getValueAt(linhaSelecionada, 0));
                    ps.setInt(2, Integer.parseInt((String) jTBUf.getValueAt(linhaSelecionada, 0)));
                    ps.execute();
                    ps.close();
                    JOptionPane.showMessageDialog(this, "Registro alterado");
                    confereBtn();
                    lista.clear();
                    lista.add(((String) jTBUf.getValueAt(linhaSelecionada, 0)));
                    lista.add(field);
                    lista.add("teste");
                    edit = false;
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        TabelaUF tabelaUf = new TabelaUF(this,null);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroUf().setVisible(true);
            }
        });
    }
